...
@Component({
  ...
  templateUrl: './create-task-template-modal.component.html',
  styleUrls: ['./create-task-template-modal.component.scss']
})
export class CreateTaskTemplateModalComponent implements OnInit {
  // @ts-ignore
  ...
  constructor(
    public dialogRef: MatDialogRef<CreateTaskTemplateModalComponent>,
